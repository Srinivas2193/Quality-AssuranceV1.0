...
function FunctionalTesting (){
    ...
    const images = [
        { img: blockChain, url: "/home/functionaltesting/blockchain", title: "Blockchain" },
        { img: Banking, url: "/home/functionaltesting/blockchain", title: "Banking" },
        { img: Fitness, url: "/home/functionaltesting/blockchain", title: "Fintech" },
        { img: Construction, url: "/home/functionaltesting/blockchain", title: "Construction" },
        { img: Iot, url: "/home/functionaltesting/blockchain", title: "IoT" },
        { img: FinancialAnalysis, url: "/home/functionaltesting/blockchain", title: "Financial and Analytical" },
        { img: Ecommerse, url: "/home/functionaltesting/blockchain", title: "e-Commerce" },
        { img: Analytics, url: "/home/functionaltesting/blockchain", title: "Analytics" },
...
<center ><img  className="pb-2" src="https://flevix.com/wp-content/uploads/2019/12/Quarter-Circle-Loading-Image-1.gif" alt="Loading" /></center>
    ...
    {mainContent && <div className="py-1 " style={{ backgroundColor: "#accbe8" }}>
      <div class="flex felx-row rounded flex-wrap gap-1 mt-10 mb-10 ml-4 md:justify-center lg:justify-center" >
        {images.map((val, i) => (
          <div class="max-w-sm  rounded hover:scale-110 ease-in duration-300 functionalcardShadow overflow-hidden shadow-lg m-9">
