...
import forgotPasswordLogo from './../../assets/images/forgotLogo.png'
...
const SavePassword=()=>{
  ...
  return (
    <>
    {emailFiels && <div className="container bg-gradient-to-r from-orange-300 to-blue-300">
      <div >
          <form className=" forgotForm bg-gradient-to-r from-blue-300 to-orange-300 shadow-md rounded px-8 pt-6 pb-8 mb-4">
          
            <div className="formFields">
            <h1 className="text-3xl mb-16 font-bold tracking-wide">Forgot Your Password ?</h1>
