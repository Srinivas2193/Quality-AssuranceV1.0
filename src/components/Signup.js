...
export default function Signup(){
    ...
    return(
        <>
        <div className='container pt-24 p-24 bg-gradient-to-r from-orange-300 to-blue-300'>
    ...
    <div className='columns-2 gap-28'>
            ...
            <br/>
            <input type='text' pattern='[A-Za-z]{3,20}' className='form-input  px-28 py-3 border-2 rounded-full outline-blue-400' placeholder='enter your firstname'
            ...
            <input type='text' pattern='[A-Za-z]{3,20}'  className='form-input  px-28 py-3 border-2 rounded-full outline-blue-400' placeholder='enter your lastname'
            ...
            <br/>
            <input type='password' className='form-input  px-28 py-3 border-2 rounded-full outline-blue-400' placeholder='enter your password' 
            ...
            <input type='password' className='form-input  px-28 py-3 border-2 rounded-full outline-blue-400' placeholder='Re-enter your password ' 
            ...
            <br/>
            <br/>
            <button type='submit' className=" bg-blue-600 hover:bg-black rounded-md px-4 py-2 text-2xl mb-5 text-white font-bold hover:ease-in duration-300" style={{marginLeft:"700px"}}>SignUp</button>
            <br/>
            <p className='text-2xl ml-[580px] mb-5'>If You Already Have An Account <Link className='text-blue-800 hover:text-black font-bold ml-3' to="/login">Login</Link></p>
    </form>
        </div>
        </>
    )
